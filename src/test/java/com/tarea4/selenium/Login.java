...
public class Login {
	...
	By localizadorSignOut = By.cssSelector("a.logout");
  ...
  public void Login(String email, String passw) {
	  ...
	  if(driver.findElement(localizadorSignIn).isDisplayed()) {
		  ...
		  assertEquals(driver.findElement(localizadorSignOut).getText(), "Sign out");
		  
		  driver.findElement(localizadorSignOut).click();
  ...
  public Object[][] dataAuthentification() {
   ...
   data [0][0] = "hegel.2000000@gmail.com";
   data [0][1] = "123456";
  ...
  public void afterClass() throws Exception {
	  this.takeSnapShot(driver, "C://Users//18297//OneDrive//Desktop//imagen//Login.png"); 
	  driver.close();
  }
